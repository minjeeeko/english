  ...
  return (
    <div className="min-h-screen bg-[#faf9f7] text-stone-800 pb-10">
      <div className="max-w-lg mx-auto px-4 pt-4">
        <button onClick={() => navigate("/")} className="mb-4 text-sm text-indigo-400 hover:text-indigo-600">
          ← 돌아가기
        </button>
        ...
        <div className="space-y-4">
          ...
          <Field label="상세 설명 (마크다운)">
            <textarea className="input-base h-28 resize-none" placeholder="**사용 예시**, 뉘앙스 등..." value={explanation} onChange={(e) => setExplanation(e.target.value)} />
          </Field>
          <Field label="유튜브 링크">
          ...
          <button
            ...
            className="w-full bg-indigo-500 hover:bg-indigo-600 disabled:opacity-40 text-white rounded-xl py-3 font-semibold active:scale-95 transition-all mt-2 shadow-sm"
          >
            {saving ? "저장 중..." : "저장"}
          </button>
        </div>
